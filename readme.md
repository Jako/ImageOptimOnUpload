...
| --- | --- | --- |
| imageoptimonupload.filetypes | jpeg,png,gif,bmp | Comma-separated list of filetypes to process. |
| imageoptimonupload.options |  | Comma-separated list of ImageOptim Options. Ex. 3000 or 100x100,crop. See [Documentation](https://imageoptim.com/api/post#options) |
